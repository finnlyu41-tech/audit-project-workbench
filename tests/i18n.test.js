...
test("every Chinese system-text literal has an English entry", () => {
  ...
  const source = ["Workbench.jsx", "components.jsx", "group-components.jsx", "deadline-alerts.jsx", "tax-deadlines.jsx", "timeline.jsx",
    "persistence-ui.jsx", "management-report.jsx", "report-ui.jsx", "template-transfer.jsx", "template-start.jsx", "annual-source-summary.jsx", "v11-components.jsx", "home-overview.jsx", "ux-components.jsx", "quick-open.jsx", "modal.jsx", "feedback.jsx", "required-text-input.jsx", "outstanding-entry.jsx", "client-followup.jsx"]
