...
test("every Chinese system-text literal has an English entry", () => {
  ...
  const source = ["working-day-fields.jsx", "date-range-picker.jsx", "Workbench.jsx", "components.jsx", "group-components.jsx", "deadline-alerts.jsx", "tax-deadlines.jsx", "timeline.jsx",
