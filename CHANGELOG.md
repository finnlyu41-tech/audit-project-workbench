...
- Keep module/project completion stable across Simple and Pro. Preserve recorded manual outcomes and real stage checks separately; only deliberate checklist edits recalculate an outcome. 完成状态不再因模式切换而反转；保留既有手动状态，不代替用户勾选审计节点。
...
- Simple modules offer direct Not started, In progress, On hold and Completed states, owner, dates and notes, without stages or nested criteria.
