// Source: HKSARG Digital Policy Office / 1823; verified 2026-09-08.
// https://www.1823.gov.hk/common/ical/en.json
// Gazetted public holidays. Sundays are excluded by the workweek rule.
export const HK_CALENDAR_VERSION = "HK-2025-2027-20260908";
export const HK_CALENDAR_MIN = "2025-01-01";
export const HK_CALENDAR_MAX = "2027-12-31";
export const HK_PUBLIC_HOLIDAYS = Object.freeze([
