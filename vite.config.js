      ...
      output: {
        ...
        codeSplitting: {
          ...
          groups: [
            ...
            { name: "workspace-core", test: /[\\/]dashboard[\\/](?:model|traditional|workspace-validation|consolidation-mode|workstream-mode|project-priority|reporting-period-tools|working-days|hk-public-holidays|efficiency-data)\.js$/, priority: 20 },
