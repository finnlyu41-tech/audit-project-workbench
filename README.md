...
新增待清事项可选择「保存并继续新增」，已提交的事项不会因取消下一条而删除。在待清中心选择「客户跟进草稿」，明确选择单一公司及年度项目、勾选事项，再预览、修改、复制或下载文本。默认不勾选事项，不包含内部备注、负责人或税务编号，不自动发送或上传。事项标题仍需人工检查。详见 [客户跟进说明](docs/client-followup.md)。
